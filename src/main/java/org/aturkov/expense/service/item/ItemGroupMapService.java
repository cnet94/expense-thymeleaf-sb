...
import org.aturkov.expense.dao.itemgroup.ItemGroupMapRepository;
...
public class ItemGroupMapService {
    private static final Logger log = LoggerFactory.getLogger(ItemGroupMapService.class);
    private final ItemGroupMapRepository itemGroupMapRepository;

    public List<ItemGroupMapEntity> findItemGroupMaps() {
        return itemGroupMapRepository.findAll();
    }
